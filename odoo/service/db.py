...
def _initialize_db(id, db_name, demo, lang, user_password, login='admin', country_code=None):
    try:
        ...
        odoo.modules.registry.Registry.new(db_name, demo, update_module=True)
...
def exp_migrate_databases(databases):
    for db in databases:
        ...
        odoo.modules.registry.Registry.new(db, force_demo=False, update_module=True, to_upgrade={'base'})
    return True
