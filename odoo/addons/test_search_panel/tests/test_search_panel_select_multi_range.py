...
class TestSelectRangeMulti(odoo.tests.TransactionCase):
    ...
    def test_many2one(self):
        ...
        self.assertEqual(
            result,
            [
                {'count': 2, 'display_name': 'Tag 1', 'id': s1_id, },
                {'count': 1, 'display_name': 'Tag 2', 'id': s2_id, },
                {'count': 0, 'display_name': 'Tag 3', 'id': s3_id, },
            ]
        )
        ...
        self.assertEqual(
            ...
            [
                {'count': 2, 'display_name': 'Tag 1', 'id': s1_id, },
                {'count': 0, 'display_name': 'Tag 2', 'id': s2_id, },
                {'count': 0, 'display_name': 'Tag 3', 'id': s3_id, },
            ],
        )
        ...
        self.assertEqual(
            result,
            [
                {'count': 0, 'display_name': 'Tag 1', 'id': s1_id, },
                {'count': 0, 'display_name': 'Tag 2', 'id': s2_id, },
                {'count': 0, 'display_name': 'Tag 3', 'id': s3_id, },
            ],
        )
    ...
    def test_many2many(self):
        ...
        self.assertEqual(
            ...
            [
                {'count': 2, 'display_name': 'Tag 1', 'id': s1_id, },
                {'count': 2, 'display_name': 'Tag 2', 'id': s2_id, },
                {'count': 2, 'display_name': 'Tag 3', 'id': s3_id, },
            ]
        )
        ...
        self.assertEqual(
            ...
            [
                {'count': 2, 'display_name': 'Tag 1', 'id': s1_id, },
                {'count': 1, 'display_name': 'Tag 2', 'id': s2_id, },
                {'count': 1, 'display_name': 'Tag 3', 'id': s3_id, },
            ],
        )
        ...
        result = self.SourceModel.search_panel_select_multi_range(
            ...
            group_by='folder_id',
            group_domain={
                str(f1_id): [('tag_ids', 'in', [s1_id]), ],
                str(f2_id): [('tag_ids', 'in', [s2_id]), ],
                str(False): [('tag_ids', 'in', [s1_id]), ('tag_ids', 'in', [s2_id]), ],
            }
        )
        self.assertEqual(
            result,
            [
                {'count': 1, 'display_name': 'Tag 1', 'id': s1_id,
                    'group_id': f2_id, 'group_name': 'Folder 2', },
                {'count': 1, 'display_name': 'Tag 2', 'id': s2_id,
                    'group_id': f1_id, 'group_name': 'Folder 1', },
                {'count': 1, 'display_name': 'Tag 3', 'id': s3_id,
        ...
        result = self.SourceModel.search_panel_select_multi_range(
            ...
            group_by='color',
            group_domain={
                'False': [('tag_ids', 'in', [s1_id]), ],
                'Green': [('tag_ids', 'in', [s1_id]), ],
            }
        )
        self.assertEqual(
            result,
