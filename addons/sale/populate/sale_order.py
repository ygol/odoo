...
class SaleOrderLine(models.Model):
    ...
    _populate_sizes = {"small": 1000, "medium": 50000, "large": 1000000}
    ...
    def _populate_factories(self):
        ...
        return [
            ...
            ("product_uom_qty", populate.randint(1, 200)), # partner_invoice_id & partner_shipping_id ???            ("display_type", _get_display_type), # TODO section & notes ???
        ]
