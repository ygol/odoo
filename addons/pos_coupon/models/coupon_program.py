...
class CouponProgram(models.Model):
    ...
    def _compute_valid_product_ids(self):
        for program in self:
            domain = safe_eval(program.rule_products_domain) if program.rule_products_domain else []
    ...
    def _compute_valid_partner_ids(self):
        for program in self:
            domain = safe_eval(program.rule_partners_domain) if program.rule_partners_domain else []
