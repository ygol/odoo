...
var SnippetsMenu = Widget.extend({
    ...
    afterRender: function() {
        for (const editor of this.snippetEditors) {
            ...
            // window.domMap = this.domMap;
            console.log('editor:', editor);
            console.log('editor.vNode:', editor.vNode);
            console.log('this.domMap.toDom(editor.vNode):', this.domMap.toDom(editor.vNode));
            ...
            for (const key in editor.snippetOptionInstances) {
                editor.snippetOptionInstances[key].setOptionTarget($snippetBlock);
            }
        }
        // debugger
