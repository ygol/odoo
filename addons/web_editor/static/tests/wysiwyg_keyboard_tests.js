...
var keyboardTestsComplex = [
    ...
    { name: "double BACKSPACE after double ENTER",
        content: "<p><b>dom to edit</b></p>",
        steps: [{start: "b:contents()[0]->3", key: 'ENTER', shiftKey: false}, {key: 'ENTER', shiftKey: false}, {key: 'BACK_SPACE'}, {key: 'BACK_SPACE'}],
        test: {
            content: "<p><b>dom to edit</b></p>",
            start: "b:contents()[0]->3",
        },
    },
    { name: "double BACKSPACE after double ENTER in empty p",
        content: "<p><br></p>",
        steps: [{start: "p->1", key: 'ENTER', shiftKey: false}, {key: 'ENTER', shiftKey: false}, {key: 'BACK_SPACE'}, {key: 'BACK_SPACE'}],
        test: {
            content: "<p><br></p>",
            start: "p->1",
        },
    },
    { name: "double BACKSPACE after ENTER in empty p after p with text",
        content: "<p>dom not to edit</p><p><br></p>",
        steps: [{start: "p:eq(1)->1", key: 'ENTER', shiftKey: false}, {key: 'BACK_SPACE'}, {key: 'BACK_SPACE'}],
        test: {
...
var keyboardTestsBackspace = [
    ...
    { name: "BACKSPACE at beginning of ul's second li's (empty) p tag",
        content: "<ul><li><p><br></p></li><li><p><br></p></li></ul>",
        steps: [{start: "p:eq(1)->1", key: 'BACK_SPACE'}],
        test: {
            content: "<ul><li><p><br></p></li></ul>",
            start: "p:first->1",
        },
