    ...
    testUtils.createAsyncView({
        ...
        defSnippets.then(function () {
            ...
            defActivateSnippet.then(function (snippet) {
                ...
                defActivateSnippet.then(function (snippet) {
                    assert.strictEqual($editable.html().replace(/\s+/g, ' '),
                        '<div class=\"s_hr pt32 pb32 built\"> <hr class=\"s_hr_1px s_hr_solid w-100 mx-auto\"> </div><div class=\"s_hr pt32 pb32 built focus\"> <hr class=\"s_hr_1px s_hr_solid w-100 mx-auto\"> </div><p>toto toto toto</p><p>tata</p>',
                        "should drop the snippet");
