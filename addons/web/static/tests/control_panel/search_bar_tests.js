odoo.define('web.search_bar_tests', function (require) {
    ...
    QUnit.module('Components', {
        ...
        QUnit.test("autocomplete menu clickout interactions", async function (assert) {
            ...
            class TestExtension extends Model.Extension {
                get(property, ...args) {
                    switch (property) {
                        case 'facets':
                            return [];
            ...
            MockedModel.registry = new Registry({testExtension: TestExtension, });
            const searchModel = new MockedModel({testExtension: {}});
