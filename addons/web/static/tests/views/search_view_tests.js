...
QUnit.module('Search View', {
    ...
    QUnit.test('groupby selected within graph subview are not deleted when modifying search view content', async function (assert) {
        ...
        await testUtils.dom.click($('div.o_graph_groupbys_menu > button'));
        await testUtils.dom.click($('div.o_graph_groupbys_menu .o_menu_item').eq(1));
        await testUtils.dom.click($('div.o_graph_groupbys_menu .o_menu_item .o_item_option > .dropdown-item').first());
    ...
    QUnit.test('dynamic filters are saved dynamic', async function (assert) {
        ...
        await testUtils.dom.click($('.o_favorites_menu .o_save_search'));
        await testUtils.dom.click($('.o_favorites_menu .o_save_name button'));
        actionManager.destroy();
    });
    ...
    QUnit.test('save filters created via autocompletion works', async function (assert) {
        ...
        await testUtils.dom.click($('.o_favorites_menu a.o_save_search'));
        await testUtils.dom.click($('.o_favorites_menu div.o_save_name button'));
    ...
    QUnit.test('time range menu in comparison mode', async function (assert) {
        ...
        $periodOptions.each(async function () {
    ...
    QUnit.test('save search filter in modal', async function (assert) {
        ...
        await testUtils.dom.click($('.o_save_search'));
        ...
        await testUtils.dom.click($('.o_save_name button'));
