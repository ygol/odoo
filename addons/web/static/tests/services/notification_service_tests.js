...
QUnit.module('Services', {
    ...
    QUnit.test('Display a question', async function (assert) {
        ...
        assert.strictEqual($notification.html().trim().replace(/\s+/g, ' '),
            "<div class=\"toast-body\"> <button type=\"button\" class=\"close o_notification_close\" data-dismiss=\"toast\" aria-label=\"Close\"> <span class=\"d-inline\" aria-hidden=\"true\">×</span> </button> <div class=\"font-weight-bold o_notification_title mb-1\">a0</div> <div class=\"o_notification_content\">b0</div> <div class=\"mt-2 o_notification_buttons\"> <button type=\"button\" class=\"btn btn-md btn-primary\"> <span>accept0</span> </button><button type=\"button\" class=\"btn btn-md btn-secondary\"> <span>refuse0</span> </button> </div> </div>",
            "should display notification");
