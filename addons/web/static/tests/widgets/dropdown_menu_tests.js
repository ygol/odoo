...
async function createDropdownMenu(dropdownTitle, groups, params) {
    params = params || {};
...
QUnit.module('Web', {
    ...
    QUnit.test('simple rendering', async function (assert) {
        ...
        var dropdownMenu = await createDropdownMenu(this.dropdownHeader, this.items);
    ...
    QUnit.test('click on an item should toggle item', async function (assert) {
        assert.expect(9);
    ...
    QUnit.test('close menu closes also submenu', async function (assert) {
        assert.expect(2);
    ...
    QUnit.test('click on an option should toggle options and item states properly', async function (assert) {
        assert.expect(22);
        ...
        await testUtils.dom.click(dropdownMenu.$('.o_item_option:first'));
        ...
        assert.doesNotHaveClass(dropdownMenu.$('.o_item_option:nth-child(3) > .dropdown-item'), 'selected');
        await testUtils.dom.click(dropdownMenu.$('.o_item_option:nth-child(3)'));
        assert.hasClass(dropdownMenu.$('.o_menu_item:nth-child(2) > .dropdown-item'), 'selected');
        assert.doesNotHaveClass(dropdownMenu.$('.o_item_option:nth-child(2) > .dropdown-item'), 'selected');
    ...
    QUnit.test('trash an item should be possible', async function (assert) {
        assert.expect(3);
        ...
        await testUtils.dom.click(dropdownMenu.$('button:first'));
        assert.containsN(dropdownMenu, '.dropdown-divider, .dropdown-item, .dropdown-item-text', 4);
        await testUtils.dom.click(dropdownMenu.$('span.o_trash_button'));
