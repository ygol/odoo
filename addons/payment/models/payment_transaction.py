...
def format_partner_address(address1="", address2=""):  # TODO move in utils
    """ Format a two parts partner address into a single-line address string. """
    return f"{address1} {address2}".strip()


def split_partner_name(partner_name):  # TODO move in utils
...
class PaymentTransaction(models.Model):
    ...
    operation = fields.Selection(
        string="Operation",
        selection=[('online_redirect', "Online payment by redirect"),
