odoo.define('payment.payment_form_mixin', require => {
    ...
    return {
         ...
         *
         * As some acquirers implement both the payment by redirect and the direct payment, the flow
         * cannot be inferred from the radio button only. The radio button only indicates whether
         * the payment option is a token. If not, the transaction context is looked up to determine
