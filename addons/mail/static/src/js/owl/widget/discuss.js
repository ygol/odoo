...
const Discuss = AbstractAction.extend(EnvMixin, {
     ...
     */
    _updateControlPanel() {
        const activeThreadLocalId = this.component.props.activeThreadLocalId;
        const hasMessages = this.component.hasActiveThreadMessages();
        const isMobile = this.component.props.isMobile;
        const activeThread = this.component.props.activeThread;
        const activeMobileNavbarTabId = this.component.props.activeMobileNavbarTabId;
        // Invite
    ...
    _onClickInvite() {
        new InvitePartnerDialog(this, {
            activeThreadLocalId: this.component.props.activeThreadLocalId,
