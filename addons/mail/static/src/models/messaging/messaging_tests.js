...
QUnit.test('openChat: open new chat for user', async function (assert) {
    ...
    assert.strictEqual(chat.viewers.length, 1, 'the chat should be displayed in a thread viewer');
});
...
QUnit.test('openChat: open existing chat for user', async function (assert) {
    ...
    assert.strictEqual(existingChat.viewers.length, 0, 'the chat should not be displayed in a thread viewer');
    ...
    assert.strictEqual(existingChat.viewers.length, 1, 'the chat should now be displayed in a thread viewer');
});
