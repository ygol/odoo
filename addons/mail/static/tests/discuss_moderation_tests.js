...
QUnit.test('moderator: display moderation box', async function (assert) {
    assert.expect(1);
...
QUnit.test('moderator: accept pending moderation message', async function (assert) {
    assert.expect(12);
    var done = assert.async();
...
QUnit.test('moderator: reject pending moderation message (reject with explanation)', async function (assert) {
    assert.expect(21);
    var done = assert.async();
...
QUnit.test('moderator: discard pending moderation message (reject without explanation)', async function (assert) {
    assert.expect(15);
    var done = assert.async();
...
QUnit.test('author: send message in moderated channel', async function (assert) {
    assert.expect(4);
    var done = assert.async();
...
QUnit.test('author: sent message accepted in moderated channel', async function (assert) {
    assert.expect(8);
    var done = assert.async();
...
QUnit.test('author: sent message rejected in moderated channel', async function (assert) {
    assert.expect(5);
    var done = assert.async();
