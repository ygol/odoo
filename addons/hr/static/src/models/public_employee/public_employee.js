...
function factory(dependencies) {
    ...
    class Employee extends dependencies['mail.model'] {
        ...
        /**
         * Gets the canonical chat between the user of this employee and the
         * current user.
         *
        ...
        async getCanonicalChat() {
            ...
            return this.user.getCanonicalChat();
        }
        ...
        async openChat(options) {
            const chat = await this.async(() => this.getCanonicalChat());
            if (!chat) {
                return;
            }
    ...
    Employee.fields = {
        ...
        id: attr(),
        /**
         * Partner related to this employee through its user.
         */
        userPartner: one2one('mail.partner', {
            inverse: 'employee',
