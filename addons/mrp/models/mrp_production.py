...
class MrpProduction(models.Model):
    ...
    @api.depends(
        ...
        'workorder_ids.state', 'move_raw_ids.quantity_done', 'product_qty')
        ...
        for production in self:
            if not production.move_raw_ids:
                ...
                production.state = 'to_close'
                 ...
                 or (production.qty_producing and production.qty_producing < production.product_qty):
                production.state = 'progress'
            else:
    ...
    def write(self, vals):
        ...
        for production in self:
            ...
            if ('lot_producing_id' or 'qty_producing' in vals and production.state == 'done'):
